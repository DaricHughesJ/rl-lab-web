...
export default function AuthModal({ initialMode = 'signup', onClose }) {
  ...
  const intro = signup ? 'Create your player profile and request alpha access.' : forgot ? 'Enter the email tied to your MechLab account.' : 'Access your alpha download, synced sessions, mechanics, and account settings.'
