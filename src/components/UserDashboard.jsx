...
function Profile({ user, profile, settings, onProfile, onSettings }) {
  ...
  async function toggleSetting(key) {
    ...
    catch (err) { onSettings(settings); setFailure(err.message || 'Could not save settings.') }
  }
